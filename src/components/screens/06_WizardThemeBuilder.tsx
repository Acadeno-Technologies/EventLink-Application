  ...
  return (
    <AdminLayout activeNav="events">
      <div className="space-y-3.5 w-full">
        ...
        {/* Main Unified Theme Builder Card */}
        <div className="bg-white rounded-2xl border border-[#DCE5F0] shadow-[0_2px_12px_rgba(7,26,51,0.03)] overflow-hidden flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-[#DCE5F0] items-stretch flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center h-9.5 px-2 bg-white border border-[#DCE5F0] rounded-xl focus-within:border-[#1463FF] focus-within:ring-2 focus-within:ring-[#1463FF]/10 transition-all">
                      <input
                        type="color"
                        value={currentTheme.colors.primary}
                        onChange={(e) => handleUpdateColors('primary', e.target.value)}
                        className="w-4.5 h-4.5 rounded cursor-pointer border-0 p-0 mr-2 bg-transparent shrink-0"
                      />
                      <input
                        type="text"
                        value={currentTheme.colors.primary}
              ...
              <div className="space-y-2">
                ...
                {showUrlInput ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    {/* Banner Thumbnail */}
                    <div className="sm:col-span-4 relative h-[56px] rounded-xl overflow-hidden border border-[#DCE5F0] shadow-2xs bg-slate-900 group">
                      <img
                        src={currentBanner}
                        alt="Banner preview"
                        onError={(e) => {
            ...
            {/* ========================================================================= */}
            <div className="lg:col-span-5 bg-[#FAFCFE] p-4 sm:p-5 flex flex-col items-center justify-center">
              
              {/* Card Header Tag */}
              <div className="w-full flex items-center justify-between mb-3 border-b border-slate-200/70 pb-2">
              ...
              <div className="w-full max-w-[315px] rounded-[34px] p-2.5 bg-[#0B1528] border-2 border-slate-800 shadow-xl relative">
                ...
                <div 
                  className="rounded-[22px] overflow-hidden p-2 flex flex-col justify-start shadow-inner transition-colors duration-300 relative"
                  style={{
                ...
                >
                  ...
                  <div className="w-full bg-white rounded-xl shadow-md overflow-hidden border border-black/5 flex flex-col transition-all">
                    ...
                    {/* Event Banner Image */}
                    <div className="w-full h-22 relative overflow-hidden bg-slate-950 shrink-0">
                      <img 
                        src={currentBanner} 
                        alt="Event banner" 
                        onError={(e) => {
                    ...
                    <div 
                      className="p-3 flex-1 flex flex-col justify-between space-y-2 bg-white"
                    ...
                    >
                      <div className="space-y-1.5">
                        <div>
                          ...
                          <p 
                            className="text-[9.5px] mt-0.5 transition-colors"
                        ...
                        <div className="space-y-1.5">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full h-7 px-2 bg-white border border-[#DCE5F0] rounded-md text-[10.5px] placeholder-[#91A4C0]"
                            />
                          </div>
          ...
          <div className="p-3.5 sm:p-4 bg-white border-t border-[#DCE5F0] flex items-center justify-between gap-3 shrink-0">
            <button
              type="button"
