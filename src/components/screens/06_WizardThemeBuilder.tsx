        ...
        <div className="bg-white rounded-2xl border border-[#DCE5F0] shadow-[0_2px_12px_rgba(7,26,51,0.03)] overflow-hidden flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-[#DCE5F0] items-stretch flex-1">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center h-10 px-2.5 bg-white border border-[#DCE5F0] rounded-xl focus-within:border-[#1463FF] focus-within:ring-2 focus-within:ring-[#1463FF]/10 transition-all">
                      <input
                        type="color"
              ...
              <div className="space-y-2.5">
                ...
                {showUrlInput ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3.5 items-center">
                    ...
                    {/* Banner Thumbnail */}
                    <div className="sm:col-span-4 relative h-[60px] rounded-xl overflow-hidden border border-[#DCE5F0] shadow-2xs bg-slate-900 group">
                      <img
                        src={currentBanner}
                        alt="Banner preview"
                        onError={(e) => {
            ...
            <div className="lg:col-span-5 bg-[#FAFCFE] p-4 sm:p-5 flex flex-col items-center justify-center">
              ...
              <div className="w-full max-w-[365px] rounded-[36px] p-3 bg-[#0B1528] border-2 border-slate-800 shadow-xl relative">
                    ...
                    >
                      <div className="space-y-2">
                        <div>
                          ...
                          >
                            Fill in details below to secure your spot.
                          </p>
                        </div>
          ...
          <div className="p-4 bg-white border-t border-[#DCE5F0] flex items-center justify-between gap-3 shrink-0">
            <button
              type="button"
