...
export const PublishConfirmationScreen: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 sm:p-10 text-center space-y-6">
        ...
        {/* Public URL Box */}
        <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/80 flex items-center justify-between gap-3 text-left">
          <div className="min-w-0 flex-1">
            <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Live Registration Link</div>
            <div className="text-xs font-mono font-bold text-blue-600 truncate mt-0.5">{publicUrl}</div>
          </div>
          <button
            onClick={handleCopyLink}
            className="h-9 px-3.5 rounded-lg bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 text-xs font-bold flex items-center gap-1.5 shrink-0 transition-colors shadow-xs cursor-pointer"
          >
        ...
        {/* QR Code Container */}
        <div className="p-6 bg-gradient-to-br from-[#0B172B] to-[#1E293B] rounded-2xl inline-block shadow-xl text-white border border-slate-800">
          ...
          <div className="p-3 bg-white rounded-xl inline-block shadow-inner">
            {qrUrl ? (
              <img src={qrUrl} alt="Event QR Code" className="w-52 h-52 mx-auto rounded-lg" />
            ) : (
          ...
          <div className="text-xs text-slate-200 font-bold mt-3 font-display">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <button
            ...
            className="h-10 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="h-10 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition-colors flex items-center justify-center gap-2 shadow-xs cursor-pointer"
          >
          ...
          <button
            ...
            className="h-10 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-colors flex items-center justify-center gap-2 shadow-xs cursor-pointer"
          >
        ...
        <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
          <button
            ...
            className="w-full sm:w-auto h-10 px-4 rounded-xl bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold border border-slate-200 flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto h-10 px-5 rounded-xl bg-[#0B172B] hover:bg-[#1E293B] text-white text-xs font-bold flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
          >
