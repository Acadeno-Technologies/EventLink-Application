  ...
  return (
    <AdminLayout activeNav="events">
      <div className="space-y-2.5 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 pb-0.5">
          <div>
            <h1 className="text-xl sm:text-[22px] font-extrabold text-[#101B33] tracking-tight font-sans">
          ...
          <div className="hidden lg:flex items-center gap-2.5 shrink-0 pr-1">
            
            {/* 3D Stylized Calendar Card */}
            <div className="relative w-11 h-11 rounded-xl bg-gradient-to-br from-[#38BDF8] via-[#1463FF] to-[#1E40AF] p-0.5 shadow-[0_4px_12px_rgba(20,99,255,0.18)] transform -rotate-3 hover:rotate-0 transition-transform">
              <div className="w-full h-full bg-[#0B254D] rounded-[9px] p-1 flex flex-col justify-between overflow-hidden relative">
                ...
                {/* Floating Plus Badge */}
                <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#1463FF] border border-white text-white flex items-center justify-center font-bold text-[8.5px] shadow-2xs">
                  +
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col text-left select-none font-['Caveat',cursive] leading-none">
        ...
        <div className="bg-white rounded-2xl border border-[#DCE5F0] shadow-[0_2px_12px_rgba(7,26,51,0.03)] p-3.5 sm:p-4">
            ...
            <div className="lg:col-span-6 space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1.5 border-b border-slate-100 pb-1.5">
                  <CalendarClock className="w-3.5 h-3.5 text-[#1463FF]" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  <div className="space-y-0.5">
                    <label className="block text-[11px] font-bold text-[#101B33]">
                    ...
                    <input
                      ...
                      className="w-full h-8 px-2.5 bg-white border border-[#DCE5F0] rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#1463FF]/10 focus:border-[#1463FF] transition-all font-medium"
                    />
                    <p className="text-[10px] text-[#7184A3]">Form activates at 00:00 on this date</p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <input
                      ...
                      className="w-full h-8 px-2.5 bg-white border border-[#DCE5F0] rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#1463FF]/10 focus:border-[#1463FF] transition-all font-medium"
                    />
                    <p className="text-[10px] text-[#7184A3]">Transitions to Closed state automatically</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-0.5">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10.5px] font-semibold text-[#1463FF]">
                      Atomically Enforced
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-32 h-8 px-2.5 bg-white border border-[#DCE5F0] rounded-xl text-xs font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#1463FF]/10 focus:border-[#1463FF] transition-all"
                    />
                  ...
                  <p className="text-[10px] text-[#7184A3]">
              ...
              <div className="p-2.5 rounded-xl bg-[#F8FAFC] border border-[#DCE5F0] space-y-1.5">
                <div className="flex items-center gap-1.5 text-[11.5px] font-bold text-[#101B33]">
                  <ShieldCheck className="w-3.5 h-3.5 text-[#1463FF]" />
                ...
                <input
                  ...
                  className="w-full h-7.5 px-2.5 bg-white border border-[#DCE5F0] rounded-lg text-[11px] text-slate-700 font-mono focus:outline-none focus:ring-2 focus:ring-[#1463FF]/10 focus:border-[#1463FF]"
                />
              </div>
            ...
            <div className="lg:col-span-6 space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <label className={`p-2.5 rounded-xl border transition-all cursor-pointer flex flex-col justify-between ${
                    ...
                    <div className="flex items-start justify-between gap-1.5 mb-1">
                      <div className="w-6 h-6 rounded-lg bg-blue-100 text-[#1463FF] flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <div className="text-xs font-bold text-[#101B33] flex items-center gap-1.5">
                        ...
                        <span className="text-[9px] font-bold text-[#1463FF] bg-blue-100/80 px-1.5 py-0.2 rounded-md">
                          Recommended
                        </span>
                      </div>
                      <div className="text-[10px] text-[#7184A3] mt-0.5 leading-snug">
                ...
                {settings.after_registration === 'redirect' && (
                  <div className="pt-0.5">
                    <input
                      ...
                      className="w-full h-8 px-2.5 bg-white border border-[#DCE5F0] rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#1463FF]/10 focus:border-[#1463FF] font-mono"
                    />
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2 pt-0.5">
                <div className="flex items-center gap-1.5 border-b border-slate-100 pb-1.5">
                  <MessageSquare className="w-3.5 h-3.5 text-[#1463FF]" />
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#101B33]">
                ...
                <div className="space-y-1.5">
                  ...
                  <label className={`flex items-center justify-between p-2 rounded-xl border transition-all cursor-pointer ${
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-[11.5px] font-bold text-[#101B33] truncate">Instant Email Confirmation</div>
                        <div className="text-[9.5px] text-[#7184A3] truncate">Automated ticket PDF pass attachment</div>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                      ...
                      className="w-3.5 h-3.5 rounded text-[#1463FF] focus:ring-[#1463FF] cursor-pointer"
                    />
                  </label>
                  ...
                  <label className={`flex items-center justify-between p-2 rounded-xl border transition-all cursor-pointer ${
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-[11.5px] font-bold text-[#101B33] truncate">WhatsApp Pass Notification</div>
                        <div className="text-[9.5px] text-[#7184A3] truncate">Meta Cloud API direct ticket message</div>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <label className={`flex items-center justify-between p-2 rounded-xl border transition-all cursor-pointer ${
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-[11.5px] font-bold text-[#101B33] truncate">Live Excel/CSV Export</div>
                        <div className="text-[9.5px] text-[#7184A3] truncate">Allow staff & organizers export access</div>
                      </div>
                    </div>
                    <input
                      type="checkbox"
        ...
        <div className="flex items-center justify-between pt-0.5">
          <button
            ...
            className="h-10 px-5 rounded-xl border border-[#DCE5F0] bg-white hover:bg-slate-50 text-slate-700 text-xs sm:text-sm font-semibold flex items-center gap-2 transition-all shadow-2xs cursor-pointer"
          >
